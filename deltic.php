...
td{
	border: 15px solid rgb(188,95,54);
	padding:25px;
...
<script>
	function calcu(qua){
		if (qua.length==0){
			...
			rt.open("GET","seatic.php?qua="+qua,true);
			rt.send();
		}
	}
</script>
...
<div id="Container">
  ...
  <div id="header_"> 
   ...
   <div class="container">
    <form class="modal-content animate" action="deltik.php" method="post"> 
	  <label><b>Ticket Number</b></label>
      <input type="text" placeholder="Ticket number" name="tid">
      <button type="submit" class="signupbtn">Cancel the Ticket</button>
   </form>
   <div id="details"></div>
      </div>
    </div>
